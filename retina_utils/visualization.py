...
from .colors import gt_colors, colors
...
def draw_detections(image, boxes, scores, labels, color=None, label_to_name=None, score_threshold=0.5):
    ...
    for i in selection:
        draw_box(image, boxes[:, i], color=colors, thickness=1)
...
def draw_annotations(image, annotations, color=(0, 255, 0), label_to_name=None, thickness=2):
    ...
    for i in range(annotations['bboxes'].shape[0]):
        ...
        draw_box(image, annotations['bboxes'][i], color=gt_colors, thickness=thickness)
